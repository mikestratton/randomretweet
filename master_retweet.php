<?php 
	 ...
	 $c = 'http://yourwebsite.com/yourfolder/files/nasa_technology_b.php'; //twitter user account
	 $d = 'http://yourwebsite.com/yourfolder/files/newscientist_b.php'; //twitter user account
